...
public class Scenario_7 {
	...
	public static void createTask()
	{
		try
		{
			oPage.getTask().click();
			Thread.sleep(2000);
			oPage.getAddNewTask_Btn().click();
			Thread.sleep(2000);
			oPage.getcreateNewTask_Btn().click();
			Thread.sleep(2000);
			oPage.getcreateTasksTableContainer().sendKeys("task1");
			Thread.sleep(2000);
	...
	static void deleteTask()
	{
		try
		{
			...
			Thread.sleep(2000);
			oPage.getDeleteTaskActionBtn().click();
			Thread.sleep(2000);
			oPage.getDeleteTaskDeleteCheckBox().click();
			Thread.sleep(2000);
			oPage.getTaskdeleteConfirm_submitTitle().click();
			Thread.sleep(2000);
